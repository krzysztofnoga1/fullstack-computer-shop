                ...
                <div className="main-div">
                    ...
                    <div className="lower-div">
                        <div className="lower-left-div">
                            <a className="spec-a">Gniazdo procesora: </a>
                            <a className="spec-a">Obsługiwane rodziny procesorów: </a>
                            <a className="spec-a">Typy obsługiwanej pamięci: </a>
                            <a className="spec-a">Maksymalna wielkość pamięci RAM: </a>
