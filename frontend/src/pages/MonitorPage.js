                ...
                <div className="main-div">
                    ...
                    <div className="lower-div">
                        <div className="lower-left-div">
                            <a className="spec-a">Przekątna ekranu: </a>
                            <a className="spec-a">Częstotliwość odświeżania: </a>
                            <a className="spec-a">Format obrazu: </a>
                            <a className="spec-a">Rozdzielczosć: </a>
                            <a className="spec-a">Złącza: </a>
                        </div>
                       
                        <div className="lower-right-div">
                            <a className="spec-a-right">{product.spec1}"</a>
                            <a className="spec-a-right">{product.spec2} Hz</a>
