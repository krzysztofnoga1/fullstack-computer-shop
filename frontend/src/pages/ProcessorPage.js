                ...
                <div className="main-div">
                    ...
                    <div className="lower-div">
                        <div className="lower-left-div">
                            <a className="spec-a">Gniazdo: </a>
                            <a className="spec-a">Taktowanie: </a>
                            <a className="spec-a">Rdzenie: </a>
                            <a className="spec-a">Pamięć podręczna(MB): </a>
                            <a className="spec-a">Wątki: </a>
                        </div>
